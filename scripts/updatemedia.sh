...
wget http://linuxtv.org/downloads/drivers/linux-media-2013-06-29.tar.bz2
wget http://linuxtv.org/downloads/drivers/linux-media-LATEST.tar.bz2
mkdir linux-media-2013-06-29
mkdir linux-media-LATEST
cd linux-media-2013-06-29
tar jxvf ../linux-media-2013-06-29.tar.bz2
...
#rm kernel_version.h
cd ..
diff -urN linux-media-2013-06-29 linux-media-LATEST > $dest
rm linux-media-2013-06-29.tar.bz2 || true
rm linux-media-LATEST.tar.bz2 || true
rm -rf linux-media-2013-06-29 || true
